...
import { IkigaiItem, IkigaiCategory, DiagramZoneType, DiagramDisplayItems } from '../types.ts'; // Added .ts
import { CATEGORY_COLORS, SVG_WIDTH, SVG_HEIGHT, CIRCLE_RADIUS, DIAGRAM_CENTERS, OPACITY, DIAGRAM_ZONE_TEXT_POSITIONS } from '../constants.ts'; // Added .ts
